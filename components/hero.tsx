...
export function Hero() {
  ...
  return (
    <section
      ref={ref}
      className="section-shell hero-aurora relative flex min-h-screen items-center justify-center overflow-hidden"
    >
      ...
      <div className="container relative z-10 px-4 pt-24 md:px-6">
        <div className="mx-auto flex max-w-6xl flex-col items-center text-center">
          ...
          >
            <motion.div
              ...
              className="inline-flex flex-wrap items-center justify-center gap-3 rounded-full border border-white/10 bg-white/[0.07] px-6 py-3 text-base text-white/90 shadow-[0_10px_35px_rgba(255,138,61,0.14)] backdrop-blur-md"
            >
            ...
            <motion.h1
              ...
              className="mt-8 text-6xl font-bold leading-[0.92] tracking-[-0.05em] md:text-8xl lg:text-[6.8rem]"
            ...
            <motion.p
              ...
              className="mx-auto mt-8 max-w-4xl text-2xl leading-10 text-white/70 md:text-[1.75rem]"
            >
            ...
            >
              <Button
                size="lg"
                className="sheen-button h-15 rounded-full bg-gradient-to-r from-[#ffd29b] via-[#ff9a4d] to-[#ff7a3d] px-9 text-lg font-semibold text-[#140b06] shadow-[0_18px_50px_rgba(255,138,61,0.24)] transition-transform duration-300 hover:scale-[1.02]"
              >
                Start a Project
              ...
              <Button
                variant="outline"
                size="lg"
                className="h-15 rounded-full border-white/15 bg-white/[0.06] px-9 text-lg text-white hover:bg-white/[0.1]"
              >
                Explore Our Work
              </Button>
            </motion.div>
